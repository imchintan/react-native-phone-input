    ...
    return (
      <View style={[styles.container, this.props.style]}>
        <TouchableOpacity
          ...
          disabled={disabled}
          style={[styles.flagBoxStyle, this.props.flagBoxStyle]}
        >
          <Image
            ...
            onPress={this.onPressFlag}
          />
          <Text style={[styles.text,{marginLeft:5, marginTop: 2}]}>{`+${this.getCountryCode()}`}</Text>
        </TouchableOpacity>
...
PhoneInput.propTypes = {
  ...
  flagBoxStyle: PropTypes.oneOfType([PropTypes.object, PropTypes.number, PropTypes.array]),
  flagStyle: PropTypes.oneOfType([PropTypes.object, PropTypes.number, PropTypes.array]),
